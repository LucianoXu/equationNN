...
from .model import ExampleDataset, ModelArgs, Transformer
...
def train():
    ...
    DATA_LEN = 100000
    MAX_STEPS = 6
    MODEL_PATH = 'acn_theory/trained_parameters.pth'
    CHECK_POINT = 'acn_theory/trained_parameters.pth'
    # CHECK_POINT = None

    # Step 1
    dataset = ExampleDataset(DATA_LEN, MAX_STEPS, max_len = SEQ_LEN)
